...
public class BidPatternParserTest {
    ...
    public void test() throws IOException {
        ...
        assertEquals(BidPattern.createBid(0, 1, new MajorSymbol()), parse("NJ2M"));
        assertEquals(BidPattern.createJump(new MajorSymbol(), 1), parse("JM"));
        assertEquals(BidPattern.createBid(1, 3, new MajorSymbol()), parse("J4M"));
        assertEquals(BidPattern.createJump(new MajorSymbol(), 2), parse("DJM"));
        assertEquals(BidPattern.createBid(2, 3, new MajorSymbol()), parse("DJ4M"));
    }
}
