...
public class BidPatternListTest {
    ...
    public void testValueOf() {
        assertEquals(new BidPatternList(List.of(BidPattern.valueOf("1S"))), BidPatternList.valueOf("1S"));
        assertEquals(new BidPatternList(List.of(BidPattern.valueOf("1S"), BidPattern.valueOf("1N"))), BidPatternList.valueOf("1S 1N"));
        assertEquals(new BidPatternList(List.of(BidPattern.valueOf("1S"), BidPattern.valueOf("(X)"), BidPattern.valueOf("1N"))),
                BidPatternList.valueOf("1S (X) 1N"));
    }

    @Test
    public void testToString() {
        assertEquals("1S", new BidPatternList(List.of(BidPattern.valueOf("1S"))).toString());
        assertEquals("1S 1N", new BidPatternList(List.of(BidPattern.valueOf("1S"), BidPattern.valueOf("1N"))).toString());
        assertEquals("1S (X) 1N",
                new BidPatternList(List.of(BidPattern.valueOf("1S"), BidPattern.valueOf("(X)"), BidPattern.valueOf("1N"))).toString());
    }
