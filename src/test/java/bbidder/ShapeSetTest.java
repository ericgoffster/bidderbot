...
public class ShapeSetTest {
    ...
    public void testValueOf() {
        ...
        assertEquals(stats[0].lengths, SuitLengthRange.between(0, 1));
        assertEquals(stats[1].lengths, SuitLengthRange.NONE.add(0).add(3));
        assertEquals(stats[2].lengths, SuitLengthRange.NONE.add(3).add(5));
        assertEquals(stats[3].lengths, SuitLengthRange.NONE.add(7));
