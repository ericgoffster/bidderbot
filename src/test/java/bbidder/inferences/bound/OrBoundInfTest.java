...
public class OrBoundInfTest {
    ...
    public void test() {
        ...
        assertTrue(i3.matches(new Players(), Hand.valueOf("AKQ xxx xxx xxxx")));
        assertTrue(i3.matches(new Players(), Hand.valueOf("AKQ Jxx xxx xxxx")));
        assertTrue(i3.matches(new Players(), Hand.valueOf("AKQ Jxx xxxx xxx")));
        assertFalse(i3.matches(new Players(), Hand.valueOf("AKJ xxx xxxxx xx")));
